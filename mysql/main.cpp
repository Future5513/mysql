...
bool QueryDatabase1(MYSQL& mysql)
{
    char query[128]{};
    sprintf(query, "select * from student"); //执行查询语句，这里是查询所有，user是表名，不用加引号，用strcpy也可以
...

{
    ...
    if(!mysql_real_connect(&mySql,"localhost","root","996926","test",3306,NULL,0))
